...
if (isset($_POST['find_dietry_type']))
    
{
    
// Retrieves title and sanitises it.
	
$dietry_type=test_input(mysqli_real_escape_string($dbconnect,$_POST ['dietry_type']));


$find_sql = "SELECT * FROM `restaurant_reviews` WHERE `dietry_req_type` = '$dietry_type' ORDER BY `dish_name` ASC";
...
?>
        ...
        <div class="box main">
            <h2>Dietry Requirement Search</h2>
