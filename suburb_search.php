...
if (isset($_POST['find_suburb']))
    
{
    
// Retrieves food by type and sanitises it.
	
$suburb=test_input(mysqli_real_escape_string($dbconnect,$_POST ['suburb']));
...
$find_sql="SELECT * FROM `restaurant_reviews` WHERE `suburb` LIKE '%$suburb%' ORDER BY `suburb` ASC ";
